...
class TestSnakes(unittest.TestCase):
    def test_is_venomous_finds_coral_snakes(self):
        ...
        self.assertEqual(snakes.is_venomous(['red', 'yellow']), "You're a dead fellow!")
        # self.assertEqual(snakes.is_venomous(['black', 'yellow', 'red', 'yellow']), "You're a dead fellow!")
        # self.assertEqual(snakes.is_venomous(['yellow', 'red', 'yellow', 'black']), "You're a dead fellow!")
        # self.assertEqual(snakes.is_venomous(['black', 'red', 'red', 'yellow']), "You're a dead fellow!")
    ...
    # def test_is_venomous_finds_scarlet_king_snakes(self):
        ...
        # self.assertEqual(snakes.is_venomous(['black', 'red']), "You're ok Jack!")
        # self.assertEqual(snakes.is_venomous(['black', 'yellow', 'black', 'red']), "You're ok Jack!")
        # self.assertEqual(snakes.is_venomous(['red', 'black', 'yellow', 'black']), "You're ok Jack!")
